$(document).ready(function(){
  ...
  test('Acronym bonus', function(){
    expect(5);
    ok(LiquidMetal.score('Hello World','HW') > LiquidMetal.score('Hello World','Hl'));
    ok(LiquidMetal.score('yet another Hello World','yaHW') > LiquidMetal.score('Hello World','yet another'));
    ok(LiquidMetal.score("Hillsdale Michigan","HiMi") > LiquidMetal.score("Chippewa Michigan","Chipp"));
    ok(LiquidMetal.score("Hillsdale Michigan","HiMi") > LiquidMetal.score("Hillsdale Michigan","Hills"));
    ok(LiquidMetal.score("Hillsdale Michigan","HiMi") < LiquidMetal.score("Hillsdale Michigan","Hillsda"));
  });
